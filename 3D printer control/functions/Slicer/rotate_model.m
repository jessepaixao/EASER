...
global bed_hight bed_width bed_center00 bed_x0 bed_y0 bed_z0
if ax == 'x'
...
%         tri_r(:,3:3:9) = tri_r(:,3:3:9) - z_adj;
        ...
        x_adj=(min(min(tri_r(:,1:3:9)))+max(max(tri_r(:,1:3:9)))-bed_x0);
        y_adj=(min(min(tri_r(:,2:3:9)))+max(max(tri_r(:,2:3:9)))-bed_y0);
        z_adj=min(min(tri_r(:,3:3:9)))+-bed_z0;
        tri_r(:,1:3:9) = tri_r(:,1:3:9) - x_adj;
        tri_r(:,2:3:9) = tri_r(:,2:3:9) - y_adj;
        tri_r(:,3:3:9) = tri_r(:,3:3:9) - z_adj;
else
